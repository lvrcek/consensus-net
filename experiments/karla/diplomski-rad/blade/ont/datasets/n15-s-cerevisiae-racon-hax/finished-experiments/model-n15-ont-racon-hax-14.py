...
def main(args):
    ...
    conv_1 = Conv1D(filters=16, kernel_size=3, padding='same', activation='selu')(input_layer)
    pool_1 = MaxPooling1D(pool_size=(2))(conv_1)
    conv_2 = Conv1D(filters=32, kernel_size=3, padding='same', activation='selu')(pool_1)
