...
def main(args):
    ...
    conv_1 = Conv1D(filters=40, kernel_size=2, padding='same', activation='relu')(input_layer)
    pool_1 = MaxPooling1D(pool_size=(2))(conv_1)
    conv_2 = Conv1D(filters=20, kernel_size=4, padding='same', activation='relu')(pool_1)
