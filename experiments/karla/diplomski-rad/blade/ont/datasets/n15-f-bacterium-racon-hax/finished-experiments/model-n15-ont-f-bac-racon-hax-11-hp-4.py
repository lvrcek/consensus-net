...
def build_model_and_callbacks(suggestion):
    ...
    conv_2 = Conv1D(filters=suggestion['filters_2'], kernel_size=suggestion['kernel_size_1'], padding='same', activation='relu', kernel_regularizer=l2(suggestion['weight_regularizer']))(pool_1)
