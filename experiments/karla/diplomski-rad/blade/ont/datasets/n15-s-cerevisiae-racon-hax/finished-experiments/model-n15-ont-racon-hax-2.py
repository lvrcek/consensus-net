...
def main(args):
    ...
    conv_1 = Conv1D(filters=20, kernel_size=3, padding='same', activation='relu')(input_layer)
    conv_2 = Conv1D(filters=10, kernel_size=3, padding='same', activation='relu')(conv_1)
