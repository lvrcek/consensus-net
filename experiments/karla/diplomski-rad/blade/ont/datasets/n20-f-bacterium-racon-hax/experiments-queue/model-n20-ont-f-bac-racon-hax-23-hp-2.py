...
def build_model_and_callbacks(suggestion):
    ...
    conv_2 = Conv1D(filters=suggestion['filters_2'], kernel_size=suggestion['kernel_size_2'], padding='same', activation='relu')(pool_1)
    pool_2 = MaxPooling1D(pool_size=(suggestion['pool_size_2']))(conv_2)
    conv_3 = Conv1D(filters=suggestion['filters_3'], kernel_size=suggestion['kernel_size_3'], padding='same', activation='relu')(pool_2)
